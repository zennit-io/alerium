...
export const CalendarTickIcon = (props: IconProps) => (
  <svg
    viewBox="0 0 24 24"
    width={24}
    height={24}
    ...
    {...props}
  >
    <path d="M16 2V5M6 2V5" strokeLinecap="round" strokeLinejoin="round" />
    <path
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M2.5 8.5H19.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
