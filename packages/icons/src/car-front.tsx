...
export const CarFrontIcon = (props: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M2.5 12L4.5 13" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M21.5 12.5L19.5 13" strokeLinecap="round" strokeLinejoin="round" />
    <path
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M20 8.5L21 8" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M4 8.5L3 8" strokeLinecap="round" strokeLinejoin="round" />
    <path
